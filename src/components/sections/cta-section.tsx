  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-20 -right-20 h-80 w-80 rounded-full bg-copper/20 blur-3xl" />
        <div className="absolute left-1/2 top-1/3 h-40 w-40 -translate-x-1/2 rounded-full bg-gold-light/15 blur-2xl" />
